...
public class collisionWithEnemy : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        {
            Instantiate (Resources.Load ("Explosion"), new Vector3 (transform.position.x, transform.position.y, 0), Quaternion.identity);
            ...
            if (playerHealth <= 0)
            {
                ...
                Destroy(GameObject.Find("playerSpacecraft(Clone)"));
